...
const infoAboutMe = function () {
  console.log("My name is Gary, I am 30 years old.");
};
...
const calculateTip = function () {
  ...
  console.log(
    `The tip is ${tipAmount}$ and the final bill is ${billAmount + tipAmount}$`
  );
};
