...
-- SELECT film_id, title, description, length, rental_rate FROM film WHERE title ILIKE '%shawshank redemption%';
...
-- SELECT title, replacement_cost FROM film GROUP BY title, replacement_cost ORDER BY replacement_cost ASC LIMIT 10;
