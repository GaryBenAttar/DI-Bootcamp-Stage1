...
let sentence = "I think I am not that bad at coding";
let wordNot = sentence.indexOf("not");
let wordBad = sentence.indexOf("bad");

if (wordBad > wordNot) {
  let substringNotBad = sentence.substring(wordNot, wordBad + 3);
  console.log(sentence.replace(substringNotBad, "good"));
} else {
